...
export type RequestData = {service:string;property:string;description:string;city:string;zip:string;date:string;time:string;name:string;email:string;phone:string;method:string;consent:boolean};
